...
with tab_map:
    ...
    if show_flag == "Flagged only":
        ...
        plot_df = plot_df[plot_df["flag"] == "FAERS-worse-than-patient"]

    color_map = {
        "agreement":                "#9aa1a8",
        "patient-worse-than-FAERS": CORAL,
        "FAERS-worse-than-patient": SLATE,
    }
...
with tab_flagged:
    ...
    if direction == "Patient-worse-than-FDA only":
        ...
        display = display[display["flag"] == "FAERS-worse-than-patient"]
